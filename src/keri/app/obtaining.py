...
witnesses = {
    "BHGK9Gem8PdiZ7PZ9WcIwxM7YnGaztYA65X3o5_RxFa8": Location(ip4="20.81.114.36", tcp=5632, http=5642),
    "B4tbPLI_TEze0pzAA-X-gewpdg22yfzN8CdKKIF5wETM": Location(ip4="20.81.117.102", tcp=5632, http=5642),
    "Boq71an-vhU6DtlZzzJF7yIqbQxb56rcxeB0LppxeDOA": Location(ip4="20.81.117.156", tcp=5632, http=5642),
    "EZ921Tv_rdgIiHURHiWwyG8vW6R69QN2sCOYUDUvfCN0": Location(ip4="20.81.119.59", tcp=5921, http=5923),
